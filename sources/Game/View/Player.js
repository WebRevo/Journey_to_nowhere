...
export default class Player
{
    ...
    setHelper()
    {
        ...
        this.helper.material.uniforms.uColor.value = new THREE.Color('#ea3323')
        this.helper.material.uniforms.uSunPosition.value = new THREE.Vector3(- 1.5, - 1.5, - 1.5)

        this.helper.geometry = new THREE.BoxGeometry(2, 5, 5, 10),
